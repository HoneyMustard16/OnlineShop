...
class Category extends MY_Controller
{
    ...
    public function create()
    {
        ...
        if ($this->category->create($input)) {
            ...
            $this->session->set_flashdata('success', 'Berhasil input category');
    ...
    public function delete($id)
    {
        ...
        if (!$content = $this->category->where('id', $id)->first()) {
            $this->session->set_flashdata('warning', 'Data tidak ditemukan!');
            redirect(base_url('category'));
        }
        ...
        if ($this->category->where('id', $id)->delete()) {
            ...
            $this->session->set_flashdata('erro', 'Data gagal dihapus!');
        }
