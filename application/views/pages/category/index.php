            ...
            <div class="col-md-10 mx-auto">
                <div class="card">
                    ...
                    <div class="card-header">
                        ...
                        <!-- button cari dan hapus -->
                        <div class="float-right">
                        <?=form_open(base_url('category/search'), ['method' => 'POST'])?>
                                <div class="input-group">
                                    <input type="text" name="keyword" class="form-control form-control-sm text-center" placeholder="Search" value="<?=$this->session->userdata('keyword')?>">
